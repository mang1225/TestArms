 ...
 */
package com.testarms.tab4.mvp.presenter;
 ...
 * Created by JessYan on 09/04/2016 10:59 <a href="mailto:jess.yan.effort@gmail.com">Contact me</a>
...
public class UserPresenter extends BasePresenter<UserContract.Model, UserContract.View> {
  ...
  /**
   * 使用 2017 Google IO 发布的 Architecture Components 中的 Lifecycles 的新特性 (此特性已被加入 Support library) 使
   * {@code Presenter} 可以与 {@link SupportActivity} 和 {@link Fragment} 的部分生命周期绑定
   */
