 ...
 */
package com.testarms.tab4.mvp.model.api.service;
...
/**
 * ================================================ 展示 {@link Retrofit#create(Class)} 中需要传入的
 * ApiService 的使用方式 存放关于用户的一些 API <p> Created by JessYan on 08/05/2016 12:05 <a
