...
import com.testarms.BuildConfig;
import com.testarms.tab4.mvp.model.api.Api;
...
/**
 * ================================================ App 的全局配置信息在此配置, 需要将此实现类声明到 AndroidManifest 中 ConfigModule 的实现类可以有无数多个, 在 Application 中只是注册回调, 并不会影响性能 (多个 ConfigModule 在多 Module 环境下尤为受用) 不过要注意
 * ConfigModule 接口的实现类对象是通过反射生成的, 这里会有些性能损耗
 *
 * @see com.jess.arms.base.delegate.AppDelegate
 * @see com.jess.arms.integration.ManifestParser Created by JessYan on 12/04/2017 17:25 <a href="mailto:jess.yan.effort@gmail.com">Contact me</a> <a href="https://github.com/JessYanCoding">Follow
 * me</a> ================================================
 */
